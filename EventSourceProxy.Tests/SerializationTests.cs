...
namespace EventSourceProxy.Tests
{
    ...
    public class SerializationTests : BaseLoggingTest
    {
        ...
        [Test]
        public void InterfaceWithClassShouldSerializeAsEmptyString()
        {
            // register the provider
        ...
        public void RegisterProviderShouldOverrideAttribute()
        {
            ...
            Listener.EnableEvents((EventSource)logger, EventLevel.Informational);
            logger.SendData(ClassData.Test);
            ...
            Listener.Reset();
            Listener.EnableEvents((EventSource)logger, EventLevel.Verbose);
            logger.SendData(ClassData.Test);
